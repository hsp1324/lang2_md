...
from tools.build_v139_release_patches import (
    SOURCE_PATH,
    TARGETS,
    build,
)
...
class V138ReleasePatcherTests(unittest.TestCase):
    ...
    def test_committed_bps_assets_are_reproducible(self):
        ...
        self.assertEqual(manifest["release"], "v1.3.9")
        self.assertEqual(
    ...
    def test_frozen_macos_defaults_next_to_app_bundle(self):
        executable = Path(
            "/Users/player/Downloads/Langrisser II Korean Patcher v1.3.9.app/"
            "Contents/MacOS/Langrisser II Korean Patcher v1.3.9"
        )
        with (
