...
class HardCurrentCandidateRuntimeTests(unittest.TestCase):
    ...
    def test_scenario_twenty_seven_runtime_targets_are_verified(self) -> None:
        ...
        self.assertEqual(
            row["gst_sha256"],
            "e35cd92cd482e98a5af0adbdf7f1be8d318f9cef087cd4d65fe6bfe56ab372cf",
        )
        self.assertEqual(
            row["capture_sha256"],
            "4788d11c6c0623b766f44c44c61b72e4d7687cd3b6a64b9dc2b8e0265757fc8c",
        )

    def test_scenario_twenty_eight_runtime_targets_are_verified(self) -> None:
        row = self.model["scenarios"][24]
        ...
        self.assertEqual(
            row["gst_sha256"],
            "3ef850385b8d0a7e0191e9fb93e3501540a05f6debe05a4fb1b7009da5789b4b",
        )
        self.assertEqual(
            row["capture_sha256"],
    ...
    def test_scenario_twenty_nine_runtime_targets_are_verified(self) -> None:
        ...
        self.assertEqual(
            row["gst_sha256"],
            "91bc66ee344297b3a7572ac133f26d19f52587d0d234b1b0babe99ac0a883019",
        )
        self.assertEqual(
            row["capture_sha256"],
    ...
    def test_scenario_thirty_runtime_targets_are_verified(self) -> None:
        ...
        self.assertEqual(
            row["gst_sha256"],
            "901555e61b57017effdbe5d0aa1c3875b8c518c960e79cb66083298757225a12",
        )
        self.assertEqual(
            row["capture_sha256"],
