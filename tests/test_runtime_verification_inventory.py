...
class RuntimeVerificationInventoryTests(unittest.TestCase):
    ...
    def test_current_evidence_matches_production_checksum(self):
        data = inventory.load_inventory()
        self.assertEqual(data["production_checksum"], "57D4")
        ...
        for scenario in data["scenarios"][:22]:
            self.assertEqual(scenario["description"], "historical")
        ...
        self.assertEqual(scenario9["description"], "historical")
        ...
        self.assertEqual(scenario10["description"], "historical")
        ...
        self.assertEqual(scenario11["description"], "historical")
        ...
        self.assertEqual(scenario12["description"], "historical")
        ...
        self.assertEqual(scenario13["description"], "historical")
        ...
        self.assertEqual(scenario15["description"], "historical")
        ...
        self.assertEqual(scenario22["description"], "historical")
