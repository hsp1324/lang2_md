...
class RuntimeVerificationInventoryTests(unittest.TestCase):
    ...
    def test_current_evidence_matches_production_checksum(self):
        ...
        for capture in (
            ...
            "captures/run/3497_s10_current_entry_19.png",
            "captures/run/3497_s10_current_turn1_00.png",
            "captures/run/3497_s10_current_turn3_00.png",
            "captures/run/3497_s10_current_turn3_68.png",
            "captures/run/3497_s10_current_turn3_177.png",
            "captures/run/3497_s10_current_turn3_220.png",
        ):
        ...
        self.assertEqual(scenario10["battle_ui"], "verified_current")
        self.assertEqual(scenario10["turn_events"], "verified_current")
        ...
        self.assertIn("Fresh unmodified production 3497 playback", scenario10["note"])
        self.assertIn("scheduled turn events are therefore verified_current", scenario10["note"])
        ...
        self.assertEqual(scenario17["branches_endings"], "verified_probe")
        for capture in (
        ...
        for capture in (
            ...
            self.assertIn(capture, scenario17["captures"])
        self.assertIn("protagonist-death diagnostic F7AB", scenario17["note"])
        self.assertIn("defeat event at 0x1A236E", scenario17["note"])
        self.assertIn("handler bytes 13 FF", scenario17["note"])
        self.assertIn("여기까지 와서 죽는 건가…", scenario17["note"])
        ...
        self.assertEqual(scenario18["battle_ui"], "verified_current")
        ...
        self.assertEqual(scenario26["battle_ui"], "verified_current")
        self.assertEqual(scenario26["completion"], "verified_probe")
        self.assertEqual(scenario26["branches_endings"], "verified_probe")
        self.assertIn("captures/run/d6a8_s26_battle_ui_10.png", scenario26["captures"])
        for capture in (
            "captures/run/1ab2_s26_current_enemy1_15.png",
            "captures/run/1ab2_s26_current_enemy1_22.png",
            "captures/run/1ab2_s26_current_enemy1_38.png",
            "captures/run/1ab2_s26_current_enemy1_45.png",
            "captures/run/1ab2_s26_current_enemy1_104.png",
            "captures/run/1ab2_s26_current_enemy1_113.png",
            "captures/run/1ab2_s26_current_enemy1_141.png",
        ):
            self.assertIn(capture, scenario26["captures"])
        self.assertIn(
        ...
        for capture in (
            "captures/run/3a54_s26_death_entry.png",
            "captures/run/3a54_s26_death_prep_12.png",
            "captures/run/3a54_s26_death_arrangement.png",
            "captures/run/3a54_s26_death_auto.png",
            "captures/run/3a54_s26_death_opening_11.png",
            "captures/run/3a54_s26_death_command.png",
            "captures/run/3a54_s26_death_start_menu.png",
            "captures/run/3a54_s26_death_event_04.png",
            "captures/run/3a54_s26_death_event_05.png",
            "captures/run/3a54_s26_death_event_06.png",
            "captures/run/3a54_s26_death_event_07.png",
        ):
            self.assertIn(capture, scenario26["captures"])
        self.assertIn("trigger at 0x1B207C", scenario26["note"])
        self.assertIn("handler 0x1B2266", scenario26["note"])
        ...
        self.assertEqual(scenario30["branches_endings"], "verified_current")
        for capture in (
        ...
        self.assertIn("trigger is 0x1B76A2", scenario30["note"])
        self.assertIn("handler 0x1B791A", scenario30["note"])
        self.assertIn("text 0x1B7DA2", scenario30["note"])
        self.assertIn("eca0_s30_turn1_16.png", scenario30["note"])
        self.assertIn("eca0_s30_turn1_17.png", scenario30["note"])
