...
class Scenario23ClearProbeTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_preserves_dragon_lord_laird_and_wizard(self):
        data = self.patched()
        layout = scenario_layout(self.source, probe_builder.SCENARIO_NUMBER)
        expected = {
            probe_builder.DRAGON_LORD_RECORD_INDEX: (
                0x2A,
                0x4B,
                10,
                45,
            ...
            probe_builder.WIZARD_RECORD_INDEX: (
                0x33,
                0x41,
                10,
                35,
    ...
    def test_runtime_clear_marks_only_hostile_runtime_groups_defeated(self):
