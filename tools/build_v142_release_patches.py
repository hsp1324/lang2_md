#!/usr/bin/env python3
"""Rebuild and verify the v1.4.2 Japanese-ROM BPS patches."""
...
def _verify_version_registry() -> None:
    expected = {
        "pure": ("ko-original-1.4.2", "1.4.2", None, "ko-original-1.4.1"),
        "normal": ("ko-normal-1.4.2", "1.4.2", None, "ko-normal-1.4.1"),
        "hard": ("ko-hard-1.4.2", "1.4.2", "1.4.2", "ko-hard-1.4.1"),
    }
