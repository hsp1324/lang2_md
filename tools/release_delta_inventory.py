...
# The report generated by this module is immutable historical evidence for the
# 5ED9 -> 99FD transition.  Keep the current public release identity separate
# so callers never compare today's ROM with that historical candidate hash.
PUBLIC_RELEASE = "v1.3.6"
PUBLIC_CANDIDATE = (
    ROOT / "roms/builds/Langrisser II (Korean Normal v1.3.6).md"
)
PUBLIC_MANIFEST = ROOT / "patches/v1.3.6.json"
PUBLIC_CANDIDATE_SHA256 = (
    "b74359800a697eea5e85d7942ac712b74360bbd8b43ff2082b88d009e94a370a"
)
PUBLIC_CANDIDATE_CHECKSUM = "1F84"
