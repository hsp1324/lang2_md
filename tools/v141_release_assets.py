#!/usr/bin/env python3
"""Single filename contract for the five v1.4.1 platform patchers."""

from __future__ import annotations


RELEASE_TAG = "v1.4.1"
RELEASE_TITLE = "v1.4.1"
WINDOWS_PATCHER_ASSET = "Langrisser-II-Korean-Patcher-v1.4.1.exe"
LINUX_PATCHER_ASSETS = {
    "x86_64": "Langrisser-II-Korean-Patcher-v1.4.1-linux-x86_64.tar.gz",
    "arm64": "Langrisser-II-Korean-Patcher-v1.4.1-linux-arm64.tar.gz",
}
MACOS_PATCHER_ASSETS = {
    "arm64": "Langrisser-II-Korean-Patcher-v1.4.1-macos-arm64.app.zip",
    "x86_64": "Langrisser-II-Korean-Patcher-v1.4.1-macos-x86_64.app.zip",
}
