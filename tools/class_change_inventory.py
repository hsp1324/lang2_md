...
LIVE_EVIDENCE = {
    ...
    (2, 0x02): [
        ...
        "captures/run/1d47_liana_natural_class_change_available.png",
        "captures/run/1d47_liana_natural_class_change_candidates.png",
        "captures/run/1d47_liana_natural_class_change_applied_status.png",
        "captures/analysis/1d47_liana_natural_class_change_before.gst",
    ...
    (3, 0x02): [
        ...
        "captures/run/1e67_lana_natural_class_change_candidates.png",
        "captures/run/1e67_lana_natural_class_change_applied_status.png",
        "captures/analysis/1e67_lana_natural_class_change_before.gst",
        "captures/analysis/1e67_lana_natural_class_change_after.gst",
    ],
    (4, 0x01): [
        ...
        "captures/run/17a6_sherry_natural_class_change_candidates.png",
        "captures/run/17a6_sherry_natural_class_change_applied_status.png",
        "captures/analysis/17a6_sherry_natural_class_change_before.gst",
    ...
    (6, 0x01): [
        ...
        "captures/run/1c26_scott_natural_class_change_candidates.png",
        "captures/run/1c26_scott_natural_class_change_applied_status.png",
        "captures/analysis/1c26_scott_natural_class_change_before.gst",
    ...
    (7, 0x01): [
        "captures/run/8e91_c7_s01_trigger.png",
    ...
    (7, 0x04): [
        ...
        "captures/run/8ea9_c7_s04_candidate1.png",
        "captures/run/8ea9_c7_s04_candidate2.png",
        "captures/run/8ea9_c7_s04_candidate3.png",
    ],
    (7, 0x06): [
        "captures/run/8eb2_c7_s06_trigger.png",
    ...
    (7, 0x08): [
        ...
        "captures/run/8eb8_c7_s08_candidate1.png",
        "captures/run/8eb8_c7_s08_candidate2.png",
        "captures/run/8eb8_c7_s08_candidate3.png",
    ],
    (7, 0x0B): [
        "captures/run/8ed3_c7_s0b_trigger.png",
        "captures/run/8ed3_c7_s0b_candidate1.png",
        "captures/run/8ed3_c7_s0b_candidate2.png",
        "captures/run/8ed3_c7_s0b_candidate3.png",
    ],
    (7, 0x0D): [
        "captures/run/8edc_c7_s0d_trigger.png",
        "captures/run/8edc_c7_s0d_candidate1.png",
        "captures/run/8edc_c7_s0d_candidate2.png",
        "captures/run/8edc_c7_s0d_candidate3.png",
    ],
    (7, 0x11): [
        "captures/run/8ed7_c7_s11_trigger.png",
        "captures/run/8ed7_c7_s11_candidate1.png",
        "captures/run/8ed7_c7_s11_candidate2.png",
        "captures/run/8ed7_c7_s11_candidate3.png",
    ],
    (7, 0x1E): [
        "captures/run/8ebe_c7_s1e_trigger.png",
        "captures/run/8ebe_c7_s1e_candidate1.png",
    ],
    (8, 0x01): [
        "captures/run/18c6_aaron_natural_class_change_available.png",
        "captures/run/18c6_aaron_natural_class_change_candidates.png",
        "captures/run/18c6_aaron_natural_class_change_applied_status.png",
        "captures/analysis/18c6_aaron_natural_class_change_before.gst",
        "captures/analysis/18c6_aaron_natural_class_change_after.gst",
    ],
    (8, 0x12): [
        "captures/run/8ed8_c8_s12_trigger.png",
        "captures/run/8ed8_c8_s12_candidate1.png",
        "captures/run/8ed8_c8_s12_candidate2.png",
        "captures/run/8ed8_c8_s12_candidate3.png",
    ],
    (8, 0x0C): [
        "captures/run/8ed9_c8_s0c_trigger.png",
        "captures/run/8ed9_c8_s0c_candidate1.png",
        "captures/run/8ed9_c8_s0c_candidate2.png",
        "captures/run/8ed9_c8_s0c_candidate3.png",
    ],
    (8, 0x0D): [
        "captures/run/8edc_c8_s0d_trigger.png",
        "captures/run/8edc_c8_s0d_candidate1.png",
        "captures/run/8edc_c8_s0d_candidate2.png",
        "captures/run/8edc_c8_s0d_candidate3.png",
    ],
    (8, 0x13): [
        "captures/run/8edd_c8_s13_trigger.png",
        "captures/run/8edd_c8_s13_candidate1.png",
        "captures/run/8edd_c8_s13_candidate2.png",
        "captures/run/8edd_c8_s13_candidate3.png",
    ],
    (8, 0x1A): [
        "captures/run/8eba_c8_s1a_trigger.png",
        "captures/run/8eba_c8_s1a_candidate1.png",
    ],
    (9, 0x01): [
    ...
    (9, 0x07): [
        ...
        "captures/run/1b14_lester_natural_class_change_candidates.png",
        "captures/run/1b14_lester_natural_class_change_applied_status.png",
        "captures/analysis/1b14_lester_natural_class_change_before.gst",
    ...
    (10, 0x03): [
        "captures/run/8e99_c10_s03_trigger.png",
    ...
    (10, 0x09): [
        ...
        "captures/run/1f96_jessica_natural_class_change_candidates.png",
        "captures/run/1f96_jessica_natural_class_change_applied_status.png",
        "captures/analysis/1f96_jessica_natural_class_change_before.gst",
        "captures/analysis/1f96_jessica_natural_class_change_after.gst",
    ],
    (10, 0x08): [
        "captures/run/8ebf_c10_s08_trigger.png",
        "captures/run/8ebf_c10_s08_candidate1.png",
        "captures/run/8ebf_c10_s08_candidate2.png",
        "captures/run/8ebf_c10_s08_candidate3.png",
    ],
    (10, 0x14): [
        "captures/run/8eb9_c10_s14_trigger.png",
        "captures/run/8eb9_c10_s14_candidate1.png",
    ],
}
NATURAL_APPLICATION_VERIFIED = {
    (1, 0x01),
    (2, 0x02),
    (3, 0x02),
    (4, 0x01),
