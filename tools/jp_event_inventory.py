...
KNOWN_STRUCTURED_RECORDS = {
    ...
    # Empire V2.0 (96%) relocates and retargets both structured records.  They
    # still satisfy the broad text-page heuristic, so keep exact fingerprints
    # for this supported source ROM as well.  Relocating either record as
    # dialogue corrupts scenario event metadata at runtime.
    0x18F690: (
        0x0202, 0x0601, 0x0019, 0x006A, 0x0201, 0x0101, 0x0019,
        0x0072, 0x0202, 0x0601, 0x0019, 0x00AC, 0xFFFF,
    ),
    0x1B0592: (
        0x0001, 0x0001, 0x001B, 0x05BE, 0x0104, 0x0002, 0x001B,
        0x065E, 0x0204, 0x0001, 0x001B, 0x066E, 0x0301, 0x0002,
        0x001B, 0x06A4, 0xFFFF,
    ),
}
