...
def patch_probe(probe: bytearray, source: bytes) -> int:
    ...
    probe[zorum + FIELD_OFFSETS["x"]] = PROBE_ZORUM_POSITION[0]
    probe[zorum + FIELD_OFFSETS["y"]] = PROBE_ZORUM_POSITION[1]
...
def main() -> int:
    ...
    print("identities, classes, levels, hidden reinforcements, and events preserved")
