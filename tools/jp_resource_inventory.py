...
# Scenario 23-31 descriptions were transcribed against the rendered Japanese
# records and reviewed statically. They still require live emulator playback.
STATIC_REVIEWED_POINTER_IDS = {
    "scenario_descriptions": frozenset(range(22, 31)),
}
...
def markdown_report(result: dict[str, object]) -> str:
    lines = [
        ...
        "",
        "A modified entry is not automatically a correct translation. Scenario 23-31",
