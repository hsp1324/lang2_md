#!/usr/bin/env python3
"""Build and verify the public v1.3.5 Japanese-ROM BPS patches."""
...
MANIFEST_PATH = PATCH_DIR / "v1.3.5.json"
...
TARGETS = (
    {
        ...
        "rom_path": ROOT
        / "roms/builds/Langrisser II (Korean Original v1.3.5).md",
        "output_filename": "Langrisser II (Korean Original v1.3.5).md",
        "patch_filename": "original-v1.3.5.bps",
        "size": 4_194_304,
        "sha256": (
    ...
    },
    {
        ...
        "rom_path": ROOT / "roms/builds/Langrisser II (Korean Normal v1.3.5).md",
        "output_filename": "Langrisser II (Korean Normal v1.3.5).md",
        "patch_filename": "normal-v1.3.5.bps",
        "size": 4_194_304,
        "sha256": (
    ...
    },
    {
        ...
        "rom_path": ROOT
        / "roms/builds/Langrisser II (Korean Hard v1.3.5).md",
        "output_filename": "Langrisser II (Korean Hard v1.3.5).md",
        "patch_filename": "hard-v1.3.5.bps",
        "size": 4_194_304,
        "sha256": (
