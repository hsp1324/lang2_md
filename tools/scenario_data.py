...
JAPANESE_NAME_BY_ID = {
    ...
    0x68: "アニキ", 0x69: "アニキ", 0x6A: "アニキ",
    0x6B: "アニキ", 0x6C: "アニキ", 0x6D: "アニキ",
}
...
for _start, _end, _label in (
    ...
    for _name_id in range(_start, _end + 1):
        KOREAN_NAME_BY_ID[_name_id] = _label
KOREAN_NAME_BY_ID[0x74] = ""
