...
This conservative scan covers maximal half-width-Japanese and uppercase-ASCII FF-terminated runs. It does not claim arbitrary executable bytes are text.

- Half-width candidates: 372
- Uppercase ASCII candidates: 77
- Total: 449
- Unclassified: 0

| Classification | Candidates |
| --- | ---: |
| `compressed_resource_data` | 152 |
| `global_font_bitmap_false_positive` | 32 |
| `global_table_string` | 225 |
...
| `structured_character_resource` | 3 |
