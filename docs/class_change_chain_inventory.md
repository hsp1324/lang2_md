...
| `0x082582` | `12` 비숍 (ﾋﾞｼｮｯﾌﾟ) | `17` 세인트 (ｾｲﾝﾄ) / `20` 킹 (ｷﾝｸﾞ) / `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) | yes | pending | pending |
| `0x08258A` | `0B` 하이로드 (ﾊｲﾛｰﾄﾞ) | `20` 킹 (ｷﾝｸﾞ) / `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) / `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) | yes | pending | pending |
| `0x082592` | `0C` 하이랜더 (ﾊｲﾗﾝﾀﾞｰ) | `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) / `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) / `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) | yes | pending | pending |
| `0x08259A` | `0D` 매직나이트 (ﾏｼﾞｯｸﾅｲﾄ) | `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) / `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) | yes | pending | pending |
| `0x0825A2` | `13` 메이지 (ﾒｲｼﾞ) | `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) | yes | pending | pending |
| `0x0825AA` | `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) | `22` 히어로 (ﾋｰﾛｰ) | yes | pending | pending |
...
| `0x0825E2` | `13` 메이지 (ﾒｲｼﾞ) | `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | yes | pending | pending |
| `0x0825EA` | `0D` 매직나이트 (ﾏｼﾞｯｸﾅｲﾄ) | `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) | yes | pending | pending |
| `0x0825F2` | `11` 프리스트 (ﾌﾟﾘｰｽﾄ) | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) | yes | pending | pending |
| `0x0825FA` | `12` 비숍 (ﾋﾞｼｮｯﾌﾟ) | `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `18` 세이지 (ｾｰｼﾞ) | yes | pending | pending |
| `0x082602` | `0B` 하이로드 (ﾊｲﾛｰﾄﾞ) | `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `18` 세이지 (ｾｰｼﾞ) / `17` 세인트 (ｾｲﾝﾄ) | yes | pending | pending |
| `0x08260A` | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | `28` 서머너 (ｻﾓﾅｰ) | yes | pending | pending |
...
| `0x08264A` | `13` 메이지 (ﾒｲｼﾞ) | `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | pending | pending | pending |
| `0x082652` | `0D` 매직나이트 (ﾏｼﾞｯｸﾅｲﾄ) | `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) | pending | pending | pending |
| `0x08265A` | `11` 프리스트 (ﾌﾟﾘｰｽﾄ) | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) | pending | pending | pending |
| `0x082662` | `12` 비숍 (ﾋﾞｼｮｯﾌﾟ) | `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `18` 세이지 (ｾｰｼﾞ) | pending | pending | pending |
| `0x08266A` | `0B` 하이로드 (ﾊｲﾛｰﾄﾞ) | `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `18` 세이지 (ｾｰｼﾞ) / `17` 세인트 (ｾｲﾝﾄ) | pending | pending | pending |
| `0x082672` | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | `28` 서머너 (ｻﾓﾅｰ) | pending | pending | pending |
...
| `0x0826B2` | `0B` 하이로드 (ﾊｲﾛｰﾄﾞ) | `17` 세인트 (ｾｲﾝﾄ) / `21` 레인저 (ﾚﾝｼﾞｬｰ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | yes | pending | pending |
| `0x0826BA` | `0E` 유니콘나이트 (ﾕﾆｺｰﾝﾅｲﾄ) | `21` 레인저 (ﾚﾝｼﾞｬｰ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `1E` 드래곤로드 (ﾄﾞﾗｺﾞﾝﾛｰﾄﾞ) | yes | pending | pending |
| `0x0826C2` | `0F` 드래곤나이트 (ﾄﾞﾗｺﾞﾝﾅｲﾄ) | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `1E` 드래곤로드 (ﾄﾞﾗｺﾞﾝﾛｰﾄﾞ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) | yes | pending | pending |
| `0x0826CA` | `12` 비숍 (ﾋﾞｼｮｯﾌﾟ) | `1E` 드래곤로드 (ﾄﾞﾗｺﾞﾝﾛｰﾄﾞ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) | yes | pending | pending |
| `0x0826D2` | `13` 메이지 (ﾒｲｼﾞ) | `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) | yes | pending | pending |
| `0x0826DA` | `21` 레인저 (ﾚﾝｼﾞｬｰ) | `23` 하이마스터 (ﾊｲﾏｽﾀｰ) | yes | pending | pending |
...
| `0x08277A` | `0F` 드래곤나이트 (ﾄﾞﾗｺﾞﾝﾅｲﾄ) | `1E` 드래곤로드 (ﾄﾞﾗｺﾞﾝﾛｰﾄﾞ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) | yes | pending | pending |
| `0x082782` | `0D` 매직나이트 (ﾏｼﾞｯｸﾅｲﾄ) | `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) / `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) | yes | pending | pending |
| `0x08278A` | `0C` 하이랜더 (ﾊｲﾗﾝﾀﾞｰ) | `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) / `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | yes | pending | pending |
| `0x082792` | `11` 프리스트 (ﾌﾟﾘｰｽﾄ) | `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `18` 세이지 (ｾｰｼﾞ) | yes | pending | pending |
| `0x08279A` | `0B` 하이로드 (ﾊｲﾛｰﾄﾞ) | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `18` 세이지 (ｾｰｼﾞ) / `17` 세인트 (ｾｲﾝﾄ) | yes | pending | pending |
| `0x0827A2` | `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) | `29` 로얄나이트 (ﾛｲﾔﾙﾅｲﾄ) | yes | pending | pending |
...
| `0x0827E2` | `0F` 드래곤나이트 (ﾄﾞﾗｺﾞﾝﾅｲﾄ) | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `1E` 드래곤로드 (ﾄﾞﾗｺﾞﾝﾛｰﾄﾞ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) | pending | pending | pending |
| `0x0827EA` | `12` 비숍 (ﾋﾞｼｮｯﾌﾟ) | `1E` 드래곤로드 (ﾄﾞﾗｺﾞﾝﾛｰﾄﾞ) / `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) | pending | pending | pending |
| `0x0827F2` | `11` 프리스트 (ﾌﾟﾘｰｽﾄ) | `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) | yes | pending | pending |
| `0x0827FA` | `1E` 드래곤로드 (ﾄﾞﾗｺﾞﾝﾛｰﾄﾞ) | `24` 드래곤마스터 (ﾄﾞﾗｺﾞﾝﾏｽﾀｰ) | yes | pending | pending |
...
| `0x08282A` | `12` 비숍 (ﾋﾞｼｮｯﾌﾟ) | `16` 하이프리스트 (ﾊｲﾌﾟﾘｰｽﾄ) / `17` 세인트 (ｾｲﾝﾄ) / `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) | yes | pending | pending |
| `0x082832` | `0B` 하이로드 (ﾊｲﾛｰﾄﾞ) | `17` 세인트 (ｾｲﾝﾄ) / `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | pending | pending | pending |
| `0x08283A` | `0C` 하이랜더 (ﾊｲﾗﾝﾀﾞｰ) | `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) | yes | pending | pending |
| `0x082842` | `0D` 매직나이트 (ﾏｼﾞｯｸﾅｲﾄ) | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) / `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) | yes | pending | pending |
| `0x08284A` | `13` 메이지 (ﾒｲｼﾞ) | `1B` 나이트마스터 (ﾅｲﾄﾏｽﾀｰ) / `1C` 그랑나이트 (ｸﾞﾗﾝﾅｲﾄ) / `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) | yes | pending | pending |
| `0x082852` | `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) | `23` 하이마스터 (ﾊｲﾏｽﾀｰ) | yes | pending | pending |
...
| `0x082892` | `10` 서펜나이트 (ｻｰﾍﾟﾝﾅｲﾄ) | `1D` 실버나이트 (ｼﾙﾊﾞｰﾅｲﾄ) / `1F` 서펜로드 (ｻｰﾍﾟﾝﾛｰﾄﾞ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | yes | pending | pending |
| `0x08289A` | `12` 비숍 (ﾋﾞｼｮｯﾌﾟ) | `1F` 서펜로드 (ｻｰﾍﾟﾝﾛｰﾄﾞ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) | yes | pending | pending |
| `0x0828A2` | `13` 메이지 (ﾒｲｼﾞ) | `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) | yes | pending | pending |
| `0x0828AA` | `1F` 서펜로드 (ｻｰﾍﾟﾝﾛｰﾄﾞ) | `2A` 서펜마스터 (ｻｰﾍﾟﾝﾏｽﾀｰ) | yes | pending | pending |
...
| `0x0828F2` | `13` 메이지 (ﾒｲｼﾞ) | `15` 위저드 (ｳｨｻﾞｰﾄﾞ) / `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) / `18` 세이지 (ｾｰｼﾞ) | pending | pending | pending |
| `0x0828FA` | `0D` 매직나이트 (ﾏｼﾞｯｸﾅｲﾄ) | `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) / `18` 세이지 (ｾｰｼﾞ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) | pending | pending | pending |
| `0x082902` | `0B` 하이로드 (ﾊｲﾛｰﾄﾞ) | `18` 세이지 (ｾｰｼﾞ) / `19` 팔라딘 (ﾊﾟﾗﾃﾞｨﾝ) / `1A` 소드마스터 (ｿｰﾄﾞﾏｽﾀｰ) | pending | pending | pending |
| `0x08290A` | `14` 아크메이지 (ｱｰｸﾒｲｼﾞ) | `26` 자베라 (ｻﾞｰｳﾞｪﾗｰ) | yes | pending | pending |
