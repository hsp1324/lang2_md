...
- `title_logo_and_main_menu`: current checksum `F9C0` (base `F9C0`). Compressed resource 393 and its 28x8 layout now render 랑그릿사 while preserving the stock II, angels, PUSH START BUTTON, copyright line, 새 게임 / 불러오기 menu, and 한글화: hsp1324 credit.
  - `captures/run/f9c0_title_logo_live.png`
  - `captures/run/f9c0_title_logo_menu.png`
