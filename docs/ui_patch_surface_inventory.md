...
- exact ownership of low-signal byte sequences outside the 6,351 reviewed font/class/sprite/item/name/graphics/system/ending/scenario/text/UI/compressed-resource/executable-core-A/core-B/core-C/core-D/core-E/core-F/core-G/core-H/startup/auxiliary/gameplay/renderer/tail candidates: the one/two-signal scan region-classifies 6,612 candidates, proves 6,350 rows are instruction/bitmap/pointer-boundary/word/graphics/layout/compressed payload data, and identifies retained scenario-level prefix L-; exact ownership of the remaining 261 executable/numeric candidates and base-relative, indexed, or dynamic access remains open
