...
- natural magic ownership and application paths beyond the production-faithful Magic Arrow proof; all 22 renderer/application paths are covered by diagnostic all-magic probes only. Natural summon ownership and the production 15-MP 형님 application path remain beyond source-locked table validation and the all-eight diagnostic renderer/application probes
