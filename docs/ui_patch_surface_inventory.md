...
- exact ownership of low-signal byte sequences outside the 6,109 reviewed font/class/sprite/item/name/graphics/system/ending/scenario/text/UI/compressed-resource/executable-core-A/core-B/core-C/core-D/core-E/startup/auxiliary/gameplay/renderer/tail candidates: the one/two-signal scan region-classifies 6,612 candidates, proves 6,108 rows are instruction/bitmap/pointer-boundary/word/graphics/layout/compressed payload data, and identifies retained scenario-level prefix L-; exact ownership of the remaining 503 executable/numeric candidates and base-relative, indexed, or dynamic access remains open
