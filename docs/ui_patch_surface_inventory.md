...
- magic targeting and result paths beyond the production-faithful Magic Arrow and diagnostic Attack, Fireball, Heal, Sleep, and Charm probes; natural summon ownership and the production 15-MP 형님 application path beyond source-locked table validation and the all-eight diagnostic renderer/application probes
