...
- exact ownership of low-signal byte sequences outside the 176 reviewed ending/scenario/text/UI-bank candidates: the one/two-signal scan region-classifies 6,612 candidates, proves 175 rows are word/layout data, and identifies retained scenario-level prefix L-; base-relative, indexed, and dynamic access elsewhere remains possible
