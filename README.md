...
- `scripts/build_korean_jp_probe.py`는 확장 ROM의 16x16 한글 글리프를 `0x7000..0x73FE` 뱅크에 저장하고 `0x71FF`는 오프닝용 공백으로 예약합니다. 시나리오 글리프 목록은 `0x270000`부터 별도로 재배치하므로 글리프 저장 영역과 겹치지 않습니다.
