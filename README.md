...
> `v1.3.9`는 철회한 후보의 상점·전장 회귀 원인을 확인해 `v1.3.8`에서 다시
> 검수 중입니다. 아직 공개하지 않았으므로 아래 v1.3.8 링크를 v1.3.9로 바꿔
> 입력하지 마세요. 404가 됩니다.
...
현재 v1.3.9 후보 패처는 일본판 ROM 또는 ZIP 하나를 고르면 위 세 ROM을 모두
생성합니다.
...
확인해 주세요. 정식 v1.3.8 이후 ROM은 공개 구 버전 세이브의 키스·레스터가
...
- [v1.3.9 패치 배포 준비 안내](docs/player_patch_distribution_v1.3.9.md)
